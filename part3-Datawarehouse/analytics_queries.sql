...
-- Business Scenario: Business Scenario: "The CEO wants to see 
-- sales performance broken down by time periods. Start with yearly
--  total, then quarterly, then monthly sales for 2024."
...
-- This demonstrates product-level performance analysis using aggregation, ranking,
-- and percentage contribution to identify top-performing products in a star schema.
-- -------------------------------------------------------------------------------
SELECT
    p.product_name,
    p.category,
...
-- It demonstrates customer value segmentation, grouping customers by spending level to 
-- analyze revenue contribution for targeted marketing.
-- ---------------------------------------------------------------------------------------
